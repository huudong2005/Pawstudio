...
export function OfficeMerchandiseSection() {
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover our magical collection of studio essentials
          </p>
        </motion.div>
        ...
        >
          <button
            onClick={() => navigate("/office-merchandise")}
          ...
          >
            ...
            <div className="relative flex items-center gap-4">
              <ShoppingBag className="w-8 h-8 text-[#E7A0FF] group-hover:text-[#A8FFEB] transition-colors duration-300" strokeWidth={2.5} />
